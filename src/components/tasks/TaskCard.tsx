...
const STATUS_OPTIONS: { value: TaskStatus; label: string; className: string }[] = [
  { value: "TODO", label: "To Do", className: "bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300" },
  { value: "IN_PROGRESS", label: "In Progress", className: "bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300" },
  { value: "IN_REVIEW", label: "In Review", className: "bg-amber-100 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300" },
  { value: "DONE", label: "Done", className: "bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300" },
];
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start">
                {STATUS_OPTIONS.map((opt) => (
                  ...
                  >
                    <span className={cn("w-2 h-2 rounded-full mr-2 inline-block", {
